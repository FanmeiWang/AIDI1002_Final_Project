...
import datetime
import sys
sys.path.append('C:/Users/Public/turnover_prediction')
...
methodologies = {
    ...
    'lgbm': False,
    'lda': False,
    'lr': True,  # 只运行 Logistic Regression
    'mnb': False,
    'pac': False,
    'per': False,
    'qda': False,
...
if __name__ == '__main__':
    ...
    directory = str(DIR + r'\summary_' + dataset_name + '_' + str(settings['setting']) + '_' + date_time + '.txt')
